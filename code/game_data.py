level_0 = {
        ...
        'mi_coins':'levels/0/level_0_mi_coins.csv',
		'fg_trees':'levels/0/level_0_fg_trees.csv',
		'bg_trees':'levels/0/level_0_bg_trees.csv',
		'enemies':'levels/0/level_0_enemies.csv',
		'constraints':'levels/0/level_0_constraints.csv',
		'player': 'levels/0/level_0_player.csv',
        'house': 'levels/0/level_0_house.csv',
        'grass': 'levels/0/level_0_grass.csv',
		'decoration': 'levels/0/level_0_decoration.csv'}